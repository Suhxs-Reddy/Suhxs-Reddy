...
**Reading.** &nbsp; *Why Machines Learn* (Anil Ananthaswamy). The thing this book does that I haven't seen anywhere else: it actually shows the math getting invented. Rosenblatt's Perceptron is a literal hardware machine in 1958. Minsky and Papert kill it with XOR. Kernels resurrect non-linear learning. Backprop is just the chain rule, but it took the field decades to admit. By the end you understand why depth matters and why so much of modern ML is gradient descent on differently shaped surfaces.
...
- *The Three-Body Problem* is, underneath the alien plot, an argument about how civilizations break their own minds. The Cultural Revolution opening sets the cosmological premise: if humans can murder their best thinkers for teaching relativity, the call to the stars will be answered by people the species has already broken. Ye Wenjie isn't a villain so much as an embodiment — the humanist whose humanism was killed by humans. The cult around her isn't fanatics off the street; it's the educated and the wealthy. Mike Evans inherits oil. Most of the others are scientists, engineers, intellectuals. Nihilism here is a privilege: it takes education to despise the species at scale and money to organize the despising. When the Trisolarans finally respond, they don't invade. They unfold a proton into eleven dimensions and use it to freeze human science. It's the most chilling first-contact move in SF, because it's the move humanity already runs on itself — punish the people who try to think clearly until they stop. The aliens just have better tools.
- *The Dark Forest* externalizes that paranoia onto the universe. The dark forest theory is its game-theoretic skeleton — every civilization a hunter, every signal a death sentence — but the body of the book is what 400 years of doomsday clock does to a species. Triumphalism collapses into the Great Ravine starvations. Hibernation creates a class of people who skip the suffering. The Wallfacer Project is the trilogy's sharpest political instrument: four people licensed to lie to the species, because the enemy reads minds. Three of them fail — Tyler the terrorist, Rey Diaz the brinkman, Hines the thought-controller — each a different way democracy can't survive a transparent adversary. Only Luo Ji works, because his solution is cosmic rather than political. The deeper claim underneath: intelligence is bounded by its own psychology. The Trisolarans understand human science perfectly through their sophons and still misread us, because they've never had to lie. Bluffing turns out to be a uniquely human technology.
- *Death's End* turns the lens on morality itself. Cheng Xin functions less as a character than as a test of human decency under cosmic load. Every choice she makes is the correct one by ordinary lights — mercy, restraint, love — and every one of them is catastrophic. Goodness, the trilogy concludes, is a luxury good, priced out at the scales we're now playing on. Behind her arc the universe reveals what it actually is, and the book's strangest cosmological idea isn't dimensional weapons themselves but the *theology* under them. The higher civilizations don't shrink dimensions for any rational reward. They do it with conviction, the way zealots burn books. Each war flattens the rules of physics a little further. Across deep time it has the shape of religious eschatology — light used to travel faster, space used to have more dimensions, and the universe we live in is the surviving liturgy of whoever was certain that *less* was purer than *more*. We aren't living in the universe. We're living in the residue of its theological wars.

**Absolute Martian Manhunter** (Deniz Camp, Javier Rodríguez). Through #10; **#11** (April 22) waiting. The Absolute imprint is a thought experiment — strip a hero of their support systems and see what's left. For J'onn the answer is the cruelest version. He isn't an alien who became a hero; he's an alien who got *absorbed*. The image under the surrealism: the survivor of a destroyed planet, put to work by the institutions that anywhere else would lock him in a cage. Camp keeps the bargain unstable on purpose. J'onn can become anyone, so what is identity when there is no fixed face? The Agency reads minds, so what is privacy when thought is jurisdiction? At its center the book is about the limit of assimilation. If a literal extraterrestrial can be folded into the federal apparatus and made useful, no edge to belonging exists that the state can't cross. What you're watching is grief turned into a job description.
