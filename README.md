...
**Reading.** &nbsp; *Why Machines Learn* (Anil Ananthaswamy). The thing this book does that I haven't seen anywhere else: it shows the math getting invented, not just explained. Rosenblatt's Perceptron is a literal hardware machine in 1958. Minsky and Papert kill it with XOR. Kernels resurrect non-linear learning. Backprop is just the chain rule, but the field took decades to admit it. Walk out the other side and modern ML stops looking like a stack of products and starts looking like the same handful of ideas finding new surfaces to descend.

Liu Cixin's **Remembrance of Earth's Past** trilogy. The longer I sit with it, the more it reads as a set of arguments about what kind of animal we are.

- *The Three-Body Problem*, underneath the alien plot, is a story about how civilizations break their own minds. The Cultural Revolution opening sets the premise: if humans murder their best thinkers for teaching relativity, the call to the stars gets answered by people the species has already broken. Ye Wenjie reads as the trilogy's central embodiment — the humanist whose humanism was killed by humans. The cult that gathers around her draws from the educated and the wealthy. Mike Evans inherits oil. Most of the rest are scientists, engineers, intellectuals. Nihilism here is a privilege; it takes education to despise the species at scale and money to organize the despising. The cult's own names give it away — *Adventists, Redemptionists, Survivors*. First contact didn't produce a political crisis. It produced a religious one. People who thought they were rationalists invented a god and started fighting about whether the god would judge or save. When the Trisolarans finally answer, they don't invade. They unfold a proton into eleven dimensions and use it to freeze human science — every photon on Earth carrying their eyes. The most chilling first-contact move in SF, and it works because it's the move humanity already runs on itself: punish the people who try to think clearly until they stop. The aliens just have better tools.
- *The Dark Forest* externalizes that paranoia onto the universe. The dark forest theory is its skeleton — every civilization a hunter, every signal a death sentence — but the body of the book is what 400 years of doomsday clock do to a species. Triumphalism collapses into the Great Ravine starvations. Hibernation breeds a generation that grew up after the threat and forgot to take it seriously, which is humanity's most embarrassing trait: we tire of fear. The Wallfacer Project is the trilogy's sharpest political move — four people licensed to lie to the entire species, because the enemy reads minds. The colder mirror, the *Wallbreakers*, is the more revealing one: every Wallfacer gets paired with a human informant who decodes the plan and feeds it to the enemy. The species cannot even keep its own secrets from itself. Three of the four Wallfacers fail. Tyler the terrorist. Rey Diaz the brinkman. Hines the thought-controller. Each a different way democracy can't survive a transparent adversary. Only Luo Ji's plan holds, and only because it operates outside politics — he weaponizes the dark forest itself, threatening to broadcast Trisolaris's coordinates and let the universe's predators handle the rest. The deeper argument underneath: intelligence is bounded by its own psychology. The Trisolarans read every human paper through their sophons and still misread us, because they've never had to lie. Bluffing turns out to be a uniquely human technology.
- *Death's End* turns the lens on morality. Cheng Xin functions less as a character than as a test of human decency under cosmic load. As swordholder she can't push the button. Later, against Wade, she refuses to let humanity build lightspeed ships. Both decisions are correct by every ordinary moral light — mercy, restraint, the protection of life — and both kill the species. Liu isn't saying she's foolish. He's saying what we call goodness is calibrated to a scale we no longer occupy. Goodness is a luxury good, priced out at the scales the trilogy is now playing on. Behind her arc the universe finally reveals what it actually is, and the strangest cosmological idea in the book is the *theology* under the dimensional weapons. The dual-vector foil isn't tactical — it's a theological proposition dressed as a weapon. The higher civilizations don't flatten dimensions for any rational reward; they do it with conviction, the way zealots burn books. Across deep time the practice has the shape of religious eschatology — light used to travel faster, space used to have more dimensions, and the physics we have is the surviving liturgy of whoever was certain that *less* was purer than *more*. We aren't living in the universe. We're living in the residue of its theological wars.

**Absolute Martian Manhunter** (Deniz Camp, Javier Rodríguez). Through #10; **#11** (April 22) waiting. The Absolute imprint is a thought experiment — strip a hero of their support systems and see what's left. For J'onn the answer is the cruellest version of the experiment. The original mythos's gentle alien refugee is gone; this J'onn is the immigrant whose only path to belonging was to become an instrument of the state's paranoia. A federal agent inside an Agency that reads minds, working psychic cases the public isn't supposed to know about. The image carries on its own — the survivor of a destroyed planet, put to work by exactly the apparatus that anywhere else would lock him in a cage. Camp keeps the unease working at every level. A shapeshifter has no fixed identity but works for a state whose business is classifying people. A telepath polices thought on behalf of a government that calls thinking a crime. There is no edge to belonging the state can't cross, no piece of the self too private to be deputized. What you're watching, page after page, is grief turned into civil service.
