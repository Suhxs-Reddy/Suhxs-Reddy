...
**Reading.** &nbsp; *Why Machines Learn* (Anil Ananthaswamy) — the rare book that lets history, math, and ML breathe at the same time. Rosenblatt's perceptron, the Minsky–Papert takedown, the long winter, backprop, kernels, the rediscovery of depth — every chapter braids the people, the equations, and the optimization story underneath. The quiet thesis: *learning is a geometry problem*, and most of modern AI is a small handful of ideas finding new loss landscapes to descend.

Liu Cixin's **Remembrance of Earth's Past** isn't a space-invasion trilogy — it's three different studies in how humanity behaves under cosmic pressure, mostly badly.

- *The Three-Body Problem* — what happens the day we learn we're not alone. Humanity doesn't unify; it **fractures into cults**. The Earth-Trisolaris Organization splits into three factions: *Adventists* who want our extinction, *Redemptionists* who want us redeemed by gods, *Survivors* who'll trade their species for a seat at the table. Liu's most uncomfortable move is sociological: the betrayers aren't peasants or fanatics — they're **the educated, the privileged, the comfortable**. Mike Evans is an oil heir. Ye Wenjie is Tsinghua-educated. The Cultural Revolution destroyed intellectuals as "class enemies"; Liu inverts that wound perfectly — in the future, the intellectual class becomes the species-traitor class, capable of nihilism precisely because privilege gave them the distance to despise the species. Then the alien response itself subverts every first-contact expectation. The Trisolarans don't invade. They unfold a single proton into eleven dimensions and use it to **break physics itself** — accelerator data goes random, fundamental research stops working, top physicists kill themselves because the universe has stopped making sense. A sufficiently advanced civilization doesn't conquer you; it freezes your epistemology and waits 400 years. The political landscape that lands on us afterward is uncanny — humanity preparing for a war it cannot fight, against an enemy four light-years away, under leaders who'll all be dead before the war begins.
- *The Dark Forest* — **strategic loneliness as a 400-year political condition.** Liu's answer to the Fermi paradox is game-theoretic horror: every civilization is a hunter in a dark forest, and the rational move is always to shoot first. Out of that grows the Wallfacer Project — four humans authorized to lie *even to the species they're saving*, because a transparent enemy reads minds. Psychologically the book is a 400-year mood swing through triumphalism, the Great Ravine starvations, and the slow grinding recognition that we were never the apex of anything. Politically it asks what democracy looks like when every decision is made for citizens who haven't been born yet.
- *Death's End* — **cosmic morality as tragedy.** Cheng Xin's arc is the cruellest kind of decency: every choice she makes for love and mercy is the *correct* human one, and it ruins everything. Politically the swordholder system — deterrence collapsed into one person's psychology, MAD compressed into a single human will. Cosmologically the reveal that the universe once had more dimensions and faster light, and every cosmic war shrinks the rules a little further. We live in the wreckage. The trilogy's final answer: morality is a luxury the cosmos doesn't budget for.

And **Absolute Martian Manhunter** (Deniz Camp / Javier Rodríguez) — through #10; **#11** (April 22) on the pile. In the original mythos J'onn is the gentle alien refugee. The Absolute version is harsher and more political: the last Martian has been **institutionalized into the very surveillance state that humanity would otherwise build against aliens like him**. He's a federal agent for an Agency that may not be real, working psychic cases in a world where reading minds is just policing. The discomfort is the point — the only outsider who could see how monstrous this apparatus is, is the one enforcing it. Psychologically Camp keeps stripping J'onn of every anchor: he can become anyone, so who is he when no one's watching? The Agency reads minds, so what relationship can he trust? It's a book about grief operationalized, identity as costume, and the loneliness of being the only witness left to a dead world — set inside the bureaucracy that, in any other DC book, would be hunting him.
