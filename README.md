...
Liu Cixin's **Remembrance of Earth's Past** isn't a space-invasion trilogy — it's three different ways the universe can be hostile.

- *The Three-Body Problem* — **scientific despair.** A physicist watches her father beaten to death by Red Guards and decides humanity isn't worth defending; the Trisolarans aren't the antagonists, human disillusionment is. Politically a Cultural Revolution wound that never closed. Cosmologically the first hint that physics itself isn't a given — sophons can lock it.
- *The Dark Forest* — **strategic loneliness.** Liu's answer to the Fermi paradox is game-theoretic horror: every civilization is a hunter in a dark forest, and the rational move is always to shoot first. Politically the Wallfacer Project — four humans authorized to lie even to the species they're saving. Psychologically a 400-year mood swing from triumphalism through the Great Ravine to the slow recognition that we were never the apex of anything.
- *Death's End* — **cosmic morality.** Cheng Xin's arc is a tragedy of decency: every choice she makes for love and mercy is the *correct* human one and ruins everything. Politically the swordholder system — deterrence collapsed into one person's psychology, MAD as a single human will. Cosmologically the universe once had more dimensions and faster light, and every war shrinks the rules a little further. We live in the wreckage. Morality is a luxury the cosmos doesn't budget for.

And **Absolute Martian Manhunter** (Deniz Camp / Javier Rodríguez) — through #10; **#11** (April 22) on the pile. The Absolute imprint strips heroes of their scaffolding, and J'onn gets the cruelest version: a federal agent for an Agency that may not be real, the last Martian operationalizing his grief into procedure. Camp keeps blurring whether the case, the Agency, or J'onn himself can be trusted. A book about identity when anyone is a costume you can wear, and the loneliness of being the only witness left to a dead world.
